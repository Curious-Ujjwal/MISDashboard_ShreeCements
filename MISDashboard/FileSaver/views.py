...
def calculate_panipat_values():
	...
	monthly_actual_performance_ratio = ((float(monthly_actual_generation_value))/(monthly_actual_irradiance*panipat_constant))*100
...
def error_page(request):
	return render(request, 'FileSaver/404page.html')

def dailyupdates(request):
	return render(request, 'FileSaver/statistics.html')
