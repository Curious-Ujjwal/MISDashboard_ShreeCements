...
# 		Here sumall is basically the sum of all the monthly_dust_loss_kwh calculated uptill the current day
# 	"""
# 	yearly_dust_loss_plf = ((float(yearly_dust_loss_kwh))/
# 	(jharkhand_constant*24*days_elapsed))*100 #in admin.py file
# 	yearly_misc_loss =
# 	yearly_generation_loss-yearly_irradiance_loss-yearly_deemed_loss_plf-yearly_grid_outage_loss_plf-yearly_bd_loss_plf-yearly_dust_loss_plf
# 	#in admin.py file
