...
class Panipat_Sheet(models.Model):
	...
	daily_irradiance_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to Low Irradiance(in %)')
	monthly_irradiance_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to Low Irradiance(in %)')
	yearly_irradiance_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to Low Irradiance(in %)')
	daily_deemed_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to Deemed(in kWh)')
	monthly_deemed_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to Deemed(in kWh)')
	yearly_deemed_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to Deemed(in kWh)')
	daily_deemed_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to Deemed(in %)')
	monthly_deemed_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to Deemed(in %)')
	yearly_deemed_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to Deemed(in %)')
	daily_grid_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss sue to GRID outage(in kWh)')
	monthly_grid_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss sue to GRID outage(in kWh)')
	yearly_grid_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss sue to GRID outage(in kWh)')
	daily_grid_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss sue to GRID outage(in %)')
	monthly_grid_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss sue to GRID outage(in %)')
	yearly_grid_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss sue to GRID outage(in %)')
	daily_bd_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to BD(in kWh)')
	monthly_bd_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to BD(in kWh)')
	yearly_bd_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to BD(in kWh)')
	daily_bd_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to BD(in %)')
	monthly_bd_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to BD(in %)')
	yearly_bd_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to BD(in %)')
	daily_dust_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to Dust(in kWh)')
	monthly_dust_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to Dust(in kWh)')
	yearly_dust_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to Dust(in kWh)')
	daily_dust_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Loss due to Dust(in %)')
	monthly_dust_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Montlhy Loss due to Dust(in %)')
	yearly_dust_loss_plf = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Loss due to Dust(in %)')
	daily_misc_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Daily Misc. Losses(in %)')
	monthly_misc_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Monthly Misc. Losses(in %)')
	yearly_misc_loss = models.DecimalField(max_digits=3, decimal_places=1, default=0.0, verbose_name='Yearly Misc. Losses(in %)')
