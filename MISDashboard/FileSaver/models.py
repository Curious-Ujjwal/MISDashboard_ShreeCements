...
class Panipat_Sheet(models.Model):
	...
	daily_grid_loss = models.DecimalField(max_digits=4, decimal_places=2, default=0.0, verbose_name='Daily Loss due to GRID outage(in kWh)')
	monthly_grid_loss = models.DecimalField(max_digits=4, decimal_places=2, default=0.0, verbose_name='Montlhy Loss due to GRID outage(in kWh)')
	yearly_grid_loss = models.DecimalField(max_digits=4, decimal_places=2, default=0.0, verbose_name='Yearly Loss due to GRID outage(in kWh)')
	daily_grid_loss_plf = models.DecimalField(max_digits=4, decimal_places=2, default=0.0, verbose_name='Daily Loss due to GRID outage(in %)')
	monthly_grid_loss_plf = models.DecimalField(max_digits=4, decimal_places=2, default=0.0, verbose_name='Montlhy Loss due to GRID outage(in %)')
	yearly_grid_loss_plf = models.DecimalField(max_digits=4, decimal_places=2, default=0.0, verbose_name='Yearly Loss due to GRID outage(in %)')
